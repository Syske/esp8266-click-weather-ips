 ...
 * 简易太空人时钟代码 
 * 作者抖音号：d88880
 * 2021.04.19 修正空气质量AQI状态显示错误的bug
 * 欢迎随意传播修改，但请保留本段注释，且不要用于商业目的
 * 
 * 目前已经发现有人在闲鱼加备注倒卖，我就不点名了。另外有
 * 人反馈旋转的小人有卡顿，因为左上角有一
 * 个实时滚动屏要预留时间做切换，性能原因特意为之。不然左
 * 上角没有动画效果。如谁有更好的办法欢迎修改后分享出来，
 * ***********************************************
 * 程序硬件介绍 esp8266 nodemcu + LCD屏幕（ST7789）
 * 
 * 自动根据当前IP获取相应天气
 * 代码凑合着看
 * 时间部分使用NTP同步阿里云服务器时间
...
const char ssid[] = "wifi";  //WIFI名称 修改这2个就可以了
